...
public:
	...
	client_mode(asio::io_context &io_context_light, asio::io_context &io_context_heavy, KCP::KCPUpdater &kcp_updater_ref, task_thread_pool::task_thread_pool &parallel_pool, const user_settings &settings) :
	...
	client_mode(client_mode &&existing_client) noexcept :
		io_context_light(existing_client.io_context_light),
		io_context_heavy(existing_client.io_context_heavy),
